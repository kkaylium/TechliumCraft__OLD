...
public class GGInits {
    ...
    public static Item GCrystal_GREEN;
    public static Item GCrystal_BLUE;
    public static Item GCrystal_PURPLE;
    public static Item GCrystal_BLACK;
