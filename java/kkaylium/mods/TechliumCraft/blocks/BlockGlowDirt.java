...
public class BlockGlowDirt extends Block implements IGrowable {
    ...
    public void registerBlockIcons(IIconRegister ir) {
        blockIcon = ir.registerIcon(TCInfo.MOD_ID + ":" + "glowDirt_bottom");
        bottomIcon = ir.registerIcon(TCInfo.MOD_ID + ":" + "glowDirt_bottom");
        for (int i = 0; i < blockColor.length; i++) {
            sideIcon[i] = ir.registerIcon(TCInfo.MOD_ID + ":" + "glowDirt" + blockColor[i] + "_side");
            topIcon[i] = ir.registerIcon(TCInfo.MOD_ID + ":" + "glowDirt" + blockColor[i] + "_top");
        }
    }
