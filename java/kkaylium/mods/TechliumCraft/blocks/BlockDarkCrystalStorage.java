...
public class BlockDarkCrystalStorage extends Block {
    ...
    public BlockDarkCrystalStorage(int color){
        ...
        this.setBlockName(TCNames.darkCrystalStorageName + "_" + TCInfo.COLOR_NAMES[color]);
    ...
    public void registerBlockIcons(IIconRegister iconregister) {
        for(int i = 0; i < textures.length; i++){
            textures[i] = iconregister.registerIcon(TCInfo.MOD_ID + ":" + "darkCrystalStorage" + "_" + TCInfo.COLOR_NAMES[colorMade]);
        }
    }
