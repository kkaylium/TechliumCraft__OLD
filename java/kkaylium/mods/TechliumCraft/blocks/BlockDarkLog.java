...
public class BlockDarkLog extends BlockLog implements ITileEntityProvider {
    ...
    public void registerBlockIcons(IIconRegister iconregister) {
        blockIcon = iconregister.registerIcon(TCInfo.MOD_ID + ":" + "darkLog_side");
        sideIcon = iconregister.registerIcon(TCInfo.MOD_ID + ":" + "darkLog_side");
        topIcon = iconregister.registerIcon(TCInfo.MOD_ID + ":" + "darkLog_top");
    }
