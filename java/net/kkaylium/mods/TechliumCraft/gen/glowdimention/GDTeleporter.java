 ...
 */
public class GDTeleporter extends Teleporter {
    ...
    public GDTeleporter(WorldServer world){
        super(world);
    ...
    public void placeInPortal(Entity par1Entity, double par2, double par4, double par6, float par8)
    {
        ...
        {
            int teleportX = MathHelper.floor_double(par1Entity.posX);
            int teleportY = MathHelper.floor_double(par1Entity.posY) - 1;
            int teleportZ = MathHelper.floor_double(par1Entity.posZ);
            byte var12 = 1;
            byte var13 = 0;
            ...
            for (int var14 = -2; var14 <= 2; ++var14)
            {
                for (int var15 = -2; var15 <= 2; ++var15)
                {
                    ...
                    {
                        int var17 = teleportX + var15 * var12 + var14 * var13;
                        int var18 = teleportY + var16;
                        int var19 = teleportZ + var15 * var13 - var14 * var12;
                        boolean var20 = var16 < 0;
                        this.worldServerInstance.setBlock(var17, var18, var19, (Block) (var20 ? TCInits.glowPortal : 0));
                    }
                }
            }

            par1Entity.setLocationAndAngles((double) teleportX, (double) teleportY + 3, (double) teleportZ, par1Entity.rotationYaw, 0.0F);
    ...
    public boolean placeInExistingPortal(Entity par1Entity, double par2, double par4, double par6, float par8)
    {
        ...
        else
        {
            for (var48 = var15 - var9; var48 <= var15 + var9; ++var48)
            {
                ...
                for (int var23 = var16 - var9; var23 <= var16 + var9; ++var23)
                {
                    ...
                    {
                        if (this.worldServerInstance.getBlock(var48, var26, var23) == TCInits.glowPortal)
                        {
                            while (this.worldServerInstance.getBlock(var48, var26 - 1, var23) == TCInits.glowCrystalStorage_RAINBOW)
                            {
                                --var26;
                            }
        ...
        if (var10 >= 0.0D)
        {
            ...
            if (this.worldServerInstance.getBlock(var12 - 1, var13, var14) == TCInits.glowCrystalStorage_RAINBOW)
            {
                var50 = 2;
            }
            ...
            if (this.worldServerInstance.getBlock(var12, var13, var14 - 1) == TCInits.glowCrystalStorage_RAINBOW)
            {
                var50 = 3;
            }
            ...
            par1Entity.setLocationAndAngles(var49, var25 + 3, var27, par1Entity.rotationYaw, par1Entity.rotationPitch);
            return true;
        }
        else
        {
    ...
    public boolean makePortal(Entity entity)
    {
        ...
        world.setBlock(x, y - 2, z, TCInits.glowPortal);
        world.setBlock(x + 1, y - 2, z + 1, TCInits.darkCrystalStorage_RAINBOW);
        world.setBlock(x + 1, y - 2, z - 1, TCInits.darkCrystalStorage_RAINBOW);
        world.setBlock(x - 1, y - 2, z + 1, TCInits.darkCrystalStorage_RAINBOW);
        world.setBlock(x - 1, y - 2, z - 1, TCInits.darkCrystalStorage_RAINBOW);
        world.setBlock(x + 1, y - 2, z, TCInits.glowCrystalStorage_RAINBOW);
        world.setBlock(x - 1, y - 2, z, TCInits.glowCrystalStorage_RAINBOW);
        world.setBlock(x, y - 2, z + 1, TCInits.glowCrystalStorage_RAINBOW);
        world.setBlock(x, y - 2, z - 1, TCInits.glowCrystalStorage_RAINBOW);
