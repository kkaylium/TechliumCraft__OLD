package net.kkaylium.mods.TechliumCraft.init.gen.tree;
 ...
 */
public class DarkTreeGen extends WorldGenTrees {
    public int minTreeHeight;

    public DarkTreeGen(int minTreeHeight, boolean vines){
            ...
            if (!flag) {
                ...
                if (isSoil && par4 < 256 - l - 1) {
                            ...
                            for (int k2 = par5 - l1; k2 <= par5 + l1; ++k2) {
                                ...
                                if (Math.abs(j2) != l1 || Math.abs(l2) != l1 || par2Random.nextInt(2) != 0 && i3 != 0) {
                                    ...
                                    if (block1.isAir(par1World, i2, k1, k2) || block1.isLeaves(par1World, i2, k1, k2)) {
                                        this.setBlockAndNotifyAdequately(par1World, i2, k1, k2, TCInits.darkGenLeaves, 0);
                                    }
                                }
                            }
                        }
                    ...
                    for (k1 = 0; k1 < l; ++k1) {
                        ...
                        if (block.isAir(par1World, par3, par4 + k1, par5) || block.isLeaves(par1World, par3, par4 + k1, par5) || block == TCInits.darkSapling) {
                            this.setBlockAndNotifyAdequately(par1World, par3, par4 + k1, par5, TCInits.darkLog, 0);
                        }
                    }
    ...
    protected boolean isReplaceable(World world, int x, int y, int z) {
        ...
        return isDarkTreeBlock(block) || super.isReplaceable(world, x, y, z);
    }

    private boolean isDarkTreeBlock(Block block) {
        return block == TCInits.darkGenLeaves || block == TCInits.darkLog || block == TCInits.darkSapling;
    }
}
