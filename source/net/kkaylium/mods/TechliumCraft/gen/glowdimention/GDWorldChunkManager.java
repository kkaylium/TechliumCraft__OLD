 ...
 */
public class GDWorldChunkManager extends WorldChunkManager {
    ...
    public GDWorldChunkManager() {
        ...
        this.myBiomesToSpawnIn.add(TCBiomeInits.GlowBiome_WHITE);
        this.myBiomesToSpawnIn.add(TCBiomeInits.GlowBiome_BLACK);
        this.myBiomesToSpawnIn.add(TCBiomeInits.GlowBiome_RED);
        this.myBiomesToSpawnIn.add(TCBiomeInits.GlowBiome_ORANGE);
        this.myBiomesToSpawnIn.add(TCBiomeInits.GlowBiome_YELLOW);
        this.myBiomesToSpawnIn.add(TCBiomeInits.GlowBiome_LIME);
        this.myBiomesToSpawnIn.add(TCBiomeInits.GlowBiome_GREEN);
        this.myBiomesToSpawnIn.add(TCBiomeInits.GlowBiome_SKY);
        this.myBiomesToSpawnIn.add(TCBiomeInits.GlowBiome_BLUE);
        this.myBiomesToSpawnIn.add(TCBiomeInits.GlowBiome_LILAC);
        this.myBiomesToSpawnIn.add(TCBiomeInits.GlowBiome_PURPLE);
        this.myBiomesToSpawnIn.add(TCBiomeInits.GlowBiome_PINK);
    }

    public GDWorldChunkManager(long seed, WorldType worldtype)
    {
        this();
        // i changed this to my GenLayerTutorial
        GenLayer[] agenlayer = GDGenLayer.makeTheWorld(seed);
        this.myGenBiomes = agenlayer[0];
        this.myBiomeIndexLayer = agenlayer[1];
    }

    public GDWorldChunkManager(World world)
    {
    ...
    public BiomeGenBase getBiomeGenAt(int x, int z)
    {
        ...
        if (biome == null)
        {
            return TCBiomeInits.GlowBiome_WHITE;
        }
    ...
    public BiomeGenBase[] getBiomesForGeneration(BiomeGenBase[] par1ArrayOfBiomeGenBase, int par2, int par3, int par4, int par5) {
        ...
        for (int i = 0; i < par4 * par5; ++i) {
            if (aint[i] >= 0) {
                par1ArrayOfBiomeGenBase[i] = TCBiomeInits.GlowBiome_BLACK;
            } else {
    ...
    public boolean areBiomesViable(int par1, int par2, int par3, List par4List) {
        ...
        for (int j2 = 0; j2 < l1 * i2; ++j2) {
            BiomeGenBase biomegenbase = TCBiomeInits.GlowBiome_BLACK;
    ...
    public float[] getRainfall(float[] par1ArrayOfFloat, int par2, int par3, int par4, int par5)
    {
        ...
        {
            float f = (float) TCBiomeInits.GlowBiome_BLACK.getIntRainfall() / 65536.0F;
