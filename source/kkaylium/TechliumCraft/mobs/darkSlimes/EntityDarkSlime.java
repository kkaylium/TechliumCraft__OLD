...
public class EntityDarkSlime extends EntitySlime{
    ...
    public EntityDarkSlime(World par1World)
    {
        super(par1World);
...
//    }
    ...
    @Override
    protected EntityDarkSlime createInstance()
    {
        return new EntityDarkSlime(this.worldObj);
    }
        ...
        if (!this.worldObj.isRemote && i > 1 && this.getHealth() <= 0.0F)
        {
           // int j = 2 + this.rand.nextInt(3);
            ...
            for (int k = 0; k < j; ++k)
            {
                ...
                EntityDarkSlime entityslime = this.createInstance();
