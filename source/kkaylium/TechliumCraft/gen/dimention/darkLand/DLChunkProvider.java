 ...
 */
public class DLChunkProvider implements IChunkProvider {
    ...
    public DLChunkProvider(World par1World, long par2, boolean par4){
    ...
    public String makeString() {
        return "DLRandomLevelSource";
    }

    @Override
    public List getPossibleCreatures(EnumCreatureType par1, int par2, int par3, int par4) {
        BiomeGenBase biomegenbase = this.worldObj.getBiomeGenForCoords(par2, par4);
        return par1 == EnumCreatureType.monster && this.scatteredFeatureGenerator.func_143030_a(par2, par3, par4) ? this.scatteredFeatureGenerator.getScatteredFeatureSpawnList() : biomegenbase.getSpawnableList(par1);
    }
